...
function userChoice() {
  useSpecialCharacter = confirm("Would you like to use special characters in your password?");
  useNumber = confirm("Would you like to use numbers in your password");
  useLowerCase = confirm("Would you like to use lowercase characters in you password?");
  useUpperCase = confirm("Would you like to use uppercase characters in you password?");
}
...
// This selects the Button In HTML
